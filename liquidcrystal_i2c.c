...
void HD44780_ClearRegion(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2)
{
  // Set the cursor position to the top-left corner of the region
  HD44780_SetCursor(x1, y1);

  // Calculate the number of columns and rows in the region
  uint8_t numColumns = x2 - x1 + 1;
  uint8_t numRows = y2 - y1 + 1;
